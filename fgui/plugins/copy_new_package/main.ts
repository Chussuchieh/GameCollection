...
menu.AddItem('复制新资源包', 'copyNewPackage', 3, false, (str) => {
    ...
    (panel.GetChild("psdInput") as any).title = chooseFolder.name;
    ...
    panel.GetChild("sure").onClick.Add(() => {
        const newPackageName = (panel.GetChild("psdInput") as any).title;
        ...
        if (str && str.trim() !== '') {
            ...
            if (sourcePath && sourcePath.trim() !== '') {
                ...
                if (destinationPath && destinationPath.trim() !== '') {
                    ...
                    const listType = $generic(CS.System.Collections.Generic.List$1, CS.System.String);
                    ...
                    FairyEditor.ProcessUtil.Start("node fs2desc.js ", list.ToArray() as any, tsProjectToolsPath, true);
